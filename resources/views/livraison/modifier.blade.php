...
<body>
    <div class="container mt-5">
        ...
        <!-- Page Title -->
        <h1 class="mt-3">Modifier une Livraison</h1>
        ...
        <form action="{{ route('livraison.update', $livraison->id) }}" method="POST">
            ...
            <div class="form-group mb-3">
                ...
                <input type="text" name="num_command_client" class="form-control" value="{{ $livraison->num_command_client }}" required>
            </div>

            <!-- Num Commande Cami -->
            <div class="form-group mb-3">
                <label for="num_commande_cami">Numéro de Commande Cami</label>
                <input type="text" name="num_commande_cami" class="form-control" value="{{ $livraison->num_commande_cami }}" required>
            </div>
            ...
            <div class="form-group mb-3">
                ...
                <select name="nom_client" class="form-control" onchange="updatePhoneNumber()" required>
                    ...
                    @foreach($clients as $client)
                        <option value="{{ $client->nom_client }}" {{ $livraison->nom_client == $client->nom_client ? 'selected' : '' }}>{{ $client->nom_client }}</option>
                    @endforeach
                </select>
            </div>
            ...
            <div class="form-group mb-3">
                ...
                <select name="tel_client" class="form-control" required>
                    ...
                    @foreach($clients as $client)
                        <option value="{{ $client->tel_client }}" {{ $livraison->tel_client == $client->tel_client ? 'selected' : '' }}>{{ $client->tel_client }}</option>
                    @endforeach
                </select>
            </div>
            ...
            <div class="form-group mb-3">
                ...
                <select name="Produits" class="form-control" onchange="calculatePoidMax()" required>
                    ...
                    @foreach($produits as $produit)
                        <option value="{{ $produit->nome }}" data-poid="{{ $produit->poid }}" {{ $livraison->Produits == $produit->nome ? 'selected' : '' }}>{{ $produit->nome }}</option>
                    @endforeach
                </select>
            </div>
            ...
            <div class="form-group mb-3">
                ...
                <input type="text" name="Ville_de_Livraison" class="form-control" value="{{ $livraison->Ville_de_Livraison }}" required>
            </div>

            <!-- Adresse de Livraison -->
            <div class="form-group mb-3">
                <label for="adresse_de_Livraison">Adresse de Livraison</label>
                <input type="text" name="adresse_de_Livraison" class="form-control" value="{{ $livraison->adresse_de_Livraison }}" required>
            </div>

            <!-- Date de Livraison -->
            <div class="form-group mb-3">
                <label for="Date_de_Livraison">Date de Livraison</label>
                <input type="date" name="Date_de_Livraison" class="form-control" value="{{ $livraison->Date_de_Livraison }}" required>
            </div>

            <!-- Quantité -->
            <div class="form-group mb-3">
                <label for="quantité">Quantité</label>
                <input type="number" name="quantité" class="form-control" value="{{ $livraison->quantité }}" oninput="calculatePoidMax()" required>
            </div>

            <!-- Commercial -->
            <div class="form-group mb-3">
                <label for="commertial">Commercial</label>
                <input type="text" name="commertial" class="form-control" value="{{ $livraison->commertial }}" required>
            </div>
            ...
            <div class="form-group mb-3">
                ...
                <select name="Matricule" class="form-control" onchange="updateKilometrage()" required>
                    ...
                    @foreach($camions as $camion)
                        <option value="{{ $camion->matrecul }}" {{ $livraison->Matricule == $camion->matrecul ? 'selected' : '' }}>{{ $camion->matrecul }}</option>
                    @endforeach
                </select>
            </div>
            ...
            <div class="form-group mb-3">
                ...
                <input type="text" name="kilométrage" class="form-control" value="{{ $livraison->kilométrage }}" required>
            </div>

            <!-- Prix Plein (Number Input) -->
            <div class="form-group mb-3">
                <label for="prix_Plein">Gasoils</label>
                <input type="number" name="prix_Plein" class="form-control" value="{{ $livraison->prix_Plein }}" step="0.01" required>
            </div>
            ...
            <div class="form-group mb-3">
                ...
                <select name="Chauffeur" class="form-control" required>
                    ...
                    @foreach($chauffeurs as $chauffeur)
                        <option value="{{ $chauffeur->nom }}" {{ $livraison->Chauffeur == $chauffeur->nom ? 'selected' : '' }}>{{ $chauffeur->nom }}</option>
                    @endforeach
                </select>
            </div>
            ...
            <div class="form-group mb-3">
                ...
                <textarea name="remarque" class="form-control">{{ $livraison->remarque }}</textarea>
            </div>

            <!-- Submit Button -->
            <button type="submit" class="btn btn-primary">Modifier la Livraison</button>
